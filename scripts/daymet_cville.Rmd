...
path_ <- "/Users/toluodukoya/Documents/Intership 2021/DAYMET Data Clean/variable_metadata.xlsx"
...
meta <- readxl::read_xlsx(path_, sheet = sheet_names_[3])
```

```{r Manipulating Geoid for easier selection, include=FALSE}
...
```{r Creating Blocks, Tract, and Block Group, include=FALSE}
  cville_blocks <- blocks(state = "51", county = cvillefips)
  cville_blocks <- cville_blocks %>%
    dplyr::select(GEOID20, geometry) %>% mutate(GEOID = GEOID20)
...
```{r Shiny app Group Color Function, include=FALSE}
# create GroupValuesIntoColors() function which allows me to specify the color and shade based on temperature for the map. 
...
```{r Blocks Color Specification, include=FALSE}

  Juneb <- subset(cville_daymet1, JuneF & Year == "1980")
  Juneb1 <- subset(cville_daymet1, JuneF & Year == "1990")
  Juneb2 <- subset(cville_daymet1, JuneF & Year == "2000")
  Juneb3 <- subset(cville_daymet1, JuneF & Year == "2010")
  Juneb4  <- subset(cville_daymet1, JuneF & Year == "2020")
  ...
  Julyb <- subset(cville_daymet1, JulyF & Year == "1980")
  Julyb1 <- subset(cville_daymet1, JulyF & Year == "1990")
  Julyb2 <- subset(cville_daymet1, JulyF & Year == "2000")
  Julyb3 <- subset(cville_daymet1, JulyF & Year == "2010")
  Julyb4  <- subset(cville_daymet1, JulyF & Year == "2020")
  ...
  Augustb <- subset(cville_daymet1, AugustF & Year == "1980")
  Augustb1 <- subset(cville_daymet1, AugustF & Year == "1990")
  Augustb2 <- subset(cville_daymet1, AugustF & Year == "2000")
  Augustb3 <- subset(cville_daymet1, AugustF & Year == "2010")
  Augustb4  <- subset(cville_daymet1, AugustF & Year == "2020")
  ...
  Totpcpb <- subset(cville_daymet1, Totpcpinch & Year == "1980")
  Totpcpb1 <- subset(cville_daymet1, Totpcpinch & Year == "1990")
  Totpcpb2 <- subset(cville_daymet1, Totpcpinch & Year == "2000")
  Totpcpb3 <- subset(cville_daymet1, Totpcpinch & Year == "2010")
  Totpcpb4  <- subset(cville_daymet1, Totpcpinch & Year == "2020")
  ...
  mapTitle <- paste0(
    ...
    , "Charlottesville DAYMET Temperature Data by Block, 1980, 1990, 2000, 2010, 2020"
    , "</p>"
  )
...
```{r Blocks Groups Color Specification, include=FALSE}
 June <- subset(cville_daymet2, JuneF & Year == "1980")
  June1 <- subset(cville_daymet2, JuneF & Year == "1990")
  June2 <- subset(cville_daymet2, JuneF & Year == "2000")
  June3 <- subset(cville_daymet2, JuneF & Year == "2010")
  June4  <- subset(cville_daymet2, JuneF & Year == "2020")
  ...
  July <- subset(cville_daymet2, JulyF & Year == "1980")
  July1 <- subset(cville_daymet2, JulyF & Year == "1990")
  July2 <- subset(cville_daymet2, JulyF & Year == "2000")
  July3 <- subset(cville_daymet2, JulyF & Year == "2010")
  July4  <- subset(cville_daymet2, JulyF & Year == "2020")
  ...
  August <- subset(cville_daymet2, AugustF & Year == "1980")
  August1 <- subset(cville_daymet2, AugustF & Year == "1990")
  August2 <- subset(cville_daymet2, AugustF & Year == "2000")
  August3 <- subset(cville_daymet2, AugustF & Year == "2010")
  August4  <- subset(cville_daymet2, AugustF & Year == "2020")
  ...
  Totpcp <- subset(cville_daymet2, Totpcpinch & Year == "1980")
  Totpcp1 <- subset(cville_daymet2, Totpcpinch & Year == "1990")
  Totpcp2 <- subset(cville_daymet2, Totpcpinch & Year == "2000")
  Totpcp3 <- subset(cville_daymet2, Totpcpinch & Year == "2010")
  Totpcp4  <- subset(cville_daymet2, Totpcpinch & Year == "2020")
  ...
  mapTitle <- paste0(
    "<p style='color:#ED7B46; font-size:14px;'>"
    , "Charlottesville DAYMET Temperature Data by Block Group, 1980, 1990, 2000, 2010, 2020"
    , "</p>"
  )
...
```{r Tracts Color Specification, include=FALSE}

  Junet <- subset(cville_daymet3, JuneF & Year == "1980")
  Junet1 <- subset(cville_daymet3, JuneF & Year == "1990")
  Junet2 <- subset(cville_daymet3, JuneF & Year == "2000")
  Junet3 <- subset(cville_daymet3, JuneF & Year == "2010")
  Junet4  <- subset(cville_daymet3, JuneF & Year == "2020")
  ...
  Julyt <- subset(cville_daymet3, JulyF & Year == "1980")
  Julyt1 <- subset(cville_daymet3, JulyF & Year == "1990")
  Julyt2 <- subset(cville_daymet3, JulyF & Year == "2000")
  Julyt3 <- subset(cville_daymet3, JulyF & Year == "2010")
  Julyt4  <- subset(cville_daymet3, JulyF & Year == "2020")
  ...
  Augustt <- subset(cville_daymet3, AugustF & Year == "1980")
  Augustt1 <- subset(cville_daymet3, AugustF & Year == "1990")
  Augustt2 <- subset(cville_daymet3, AugustF & Year == "2000")
  Augustt3 <- subset(cville_daymet3, AugustF & Year == "2010")
  Augustt4  <- subset(cville_daymet3, AugustF & Year == "2020")
  ...
  Totpcpt <- subset(cville_daymet3, Totpcpinch & Year == "1980")
  Totpcpt1 <- subset(cville_daymet3, Totpcpinch & Year == "1990")
  Totpcpt2 <- subset(cville_daymet3, Totpcpinch & Year == "2000")
  Totpcpt3 <- subset(cville_daymet3, Totpcpinch & Year == "2010")
  Totpcpt4  <- subset(cville_daymet3, Totpcpinch & Year == "2020")
  ...
  mapTitle <- paste0(
    "<p style='color:#ED7B46; font-size:14px;'>"
    , "Charlottesville DAYMET Temperature Data by Tracts, 1980, 1990, 2000, 2010, 2020"
    , "</p>"
  )
...
**Source:** **Daymet:** Monthly Climate Summaries on a 1-km Grid for
North America, Version 4, December 2020 release. The first link is a
direct download link from the Daymet website, however, you have to
register and sign in to download the file. The second link is to the
fedData documentation which allows you to directly download the dayment
data without signing in.

- **DAYMET Direct Data Download URL:**
  <https://daac.ornl.gov/cgi-bin/dsviewer.pl?ds_id=1855>

- **FedData Documentation URL:**
  [https://ropensci.org/blog/2017/08/24/feddata-release/](hhttps://ropensci.org/blog/2017/08/24/feddata-release/)

## The Data Used Here

Daymet is a data product derived from a collection of algorithms and
computer software designed to interpolate and extrapolate from daily
meteorological observations to produce gridded estimates of daily
weather parameters.

Weather parameters generated include **daily surfaces of minimum and
maximum temperature, precipitation, vapor pressure, radiation, snow
water equivalent, and day length produced on a 1 km x 1 km gridded
surface**.

The motivation for producing Daymet is to provide measurements of
near-surface meteorological conditions where no instrumentation exists.
Having estimates of these surfaces is critical to understanding many
processes in the terrestrial biogeochemical system.

Daymet model predicted data for the three model parameters: tmin, tmax,
and prcp. Also included are corresponding station metadata files for
each variable and year, including the station name, station
identification, latitude, and longitude. The data covers years from
1980-2020.

The data here is the **monthly data at the block, block groups, and
tract level for Albemarle, Charlottesville, Louisa, Greene, Fluvanna,
Nelson, counties** in Virginia . While DAYMET includes information on a
variety of climate measures, we are focusing on the maximum temperature
and precipitation of the counties of interest.

The maximum temperature was originally recorded in Celsuis and the
precipitation in Millimeters, they were both converted to **Fahrenheit
and Inches respectively** to make it easier for our audience.

**To Learn More, See:**

- [Daily Surface Weather and Climatological
  Summaries](https://daymet.ornl.gov/overview)

# Analysis {.tabset}

The data has the federal information processing system (FIPS) codes
which are used to identify a geographical location, both the state and
county FIPS code are in the data. The census tract number, the census
block number, thr geographical ID number of the block, the block name,
the year we are observing, and temperature data.

The data has years of observation **1980, 1990, 2000, 2010, and 2020,**
the temperature data for each county for the months of **June, July, and
August, for all years, and the total annual precipitation** for the
counties, for all years.

**Temperature observations are county level estimates of...**

- Monthly maximum temperature for each county for years 1980, 1990,
  2000, 2010, and 2020.

  - Average for the months of June, July, and August, for each county.
    The visualizations are using data in Fahrenheit.  
    
   - 

- Yearly precipitation for each county for years 1980, 1990, 2000, 2010,
  and 2020.

  - Total yearly precipitation for each county for those years. The
    visualizations are using data in Inches.

## Blocks {.tabset}

### Variable Description

**A Brief View of the Block Level Data for the Charlottesville Region**

```{r Block Table, echo=FALSE}
daymet1a <- filter(daymet1, GEOID %in% c("510030101001000", "510650201011000", "510790301011000", "511099501001000", "511259501001000", "515400002011000"))
kbl(daymet1a) %>%
...
**Summary of the Charlottesville Region Block Level Data**

```{r Block Summary, echo=FALSE}
daymet1 %>%  dplyr::select(-c(STATEFP:NAMES, June:August, Totpcp)) %>% 
...
The goal of the project is to identify the effects of climate change on
the hot weather patterns in the counties. We chose June, July, August as
the months of interest because they represent summer months. We believe
they are the hottest months of the year and allows us to observe
temperature fluctuations in stable month periods.

We also chose **1980, 1990, 2000, 2010, and 2020** as years to explore
because of the density of the available data and for clearer
understanding of variation over time.

**This is an interactive graph.** Click on the graph to **zoom and click
on the counties to see information on the temperature** for that
location. **Click through each year** to see the changes in the block
level temperature readings for all counties for each year.

```{r Block Maps, echo=FALSE}
shinyApp(ui = shiny::fluidPage(
  titlePanel(title = h4("Charlottesville DAYMET Temperature Data by Block: Years: 1980, 1990, 2000, 2010, 2020")),
  mainPanel(
...
**A Brief View of the Block Group Level Data for the Charlottesville
Region**

```{r Block Group Table, echo=FALSE}
daymet2a <- filter(daymet2, GEOID %in% c("510030101001", "510650201011", "510790301011", "511099501001", "511259501001", "515400002011"))
kbl(daymet2a) %>%
  kable_paper(full_width = F)  %>% 
   scroll_box(width = "800px", height = "300px")
```
...
**Summary of the Charlottesville Region Block Group Level Data**

```{r Block Group Summary, echo=FALSE}
...
```{r Block Group Maps, echo=FALSE}
shinyApp(ui = shiny::fluidPage(
  titlePanel(title = h4("Charlottesville DAYMET Temperature Data by Block Group: Years: 1980, 1990, 2000, 2010, 2020")),
  mainPanel(
...
**A Brief View of the Tract Level Data for the Charlottesville Region**

```{r Tract Table, echo=FALSE}
daymet3a <- filter(daymet3, GEOID %in% c("51003010100", "51065020101", "51079030101", "51109950100", "51125950100", "51540000201"))
kbl(daymet3a) %>%
  kable_paper(full_width = F)  %>% 
   scroll_box(width = "800px", height = "300px")
```
...
**Summary of the Charlottesville Region Tract Level Data**

```{r Tract Summary, echo=FALSE}
...
```{r Tract Maps, echo=FALSE}
shinyApp(ui = shiny::fluidPage(
  titlePanel(title = h4("Charlottesville Region DAYMET Temperature Data by Tracts: Years: 1980, 1990, 2000, 2010, 2020")),
  mainPanel(
...
The results show that temperature has increased steadily over the years
in. Charlottesville likely due to the reduction in green spaces in the
area.
